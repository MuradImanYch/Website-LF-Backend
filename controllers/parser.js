...
const parsing = async () => {
    ...
    db.query('DELETE FROM matchesslider', (err => {
        if(err) throw err;
    }));

    matchesSlider.map((e) => {
        db.query('INSERT INTO matchesslider (hName, aName, hLogo, aLogo, lLogo, w1, d, w2, lName, round, roundInfo, stadium, refree, weatherIco, weatherDescr, venue, dateTime) VALUES(?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)', [e.hName, e.aName, e.hLogo, e.aLogo, e.lLogo, e.w1, e.d, e.w2, e.lNameRoundDateTime[0], e.lNameRoundDateTime[1], e.lNameRoundDateTime[2], e.stadium, e.refree, e.weatherIco, e.weatherDescr, e.venue, e.lNameRoundDateTime[e.lNameRoundDateTime.length - 1]], (err => {
            if(err) throw err;
        }));
    });
    ...
    uclStandingsA.map((e) => {
        db.query('INSERT INTO uclstandingsa (standingsGroup, name, description, place, logo, games, goalsFor, goalsAgainst, points, descrLat) VALUES(?, ?, ?, ?, ?, ?, ?, ?, ?, ?)', [e.group, e.name, e.description, e.place, e.logo, e.games, e.goalsFor, e.goalsAgainst, e.points, e.descrLat], (err => {
            if(err) throw err;
        }));
    });
    ...
    uclStandingsB.map((e) => {
        db.query('INSERT INTO uclstandingsb (standingsGroup, name, description, place, logo, games, goalsFor, goalsAgainst, points, descrLat) VALUES(?, ?, ?, ?, ?, ?, ?, ?, ?, ?)', [e.group, e.name, e.description, e.place, e.logo, e.games, e.goalsFor, e.goalsAgainst, e.points, e.descrLat], (err => {
            if(err) throw err;
        }));
    });
    ...
    uclStandingsC.map((e) => {
        db.query('INSERT INTO uclstandingsc (standingsGroup, name, description, place, logo, games, goalsFor, goalsAgainst, points, descrLat) VALUES(?, ?, ?, ?, ?, ?, ?, ?, ?, ?)', [e.group, e.name, e.description, e.place, e.logo, e.games, e.goalsFor, e.goalsAgainst, e.points, e.descrLat], (err => {
            if(err) throw err;
        }));
    });
    ...
    uclStandingsD.map((e) => {
        db.query('INSERT INTO uclstandingsd (standingsGroup, name, description, place, logo, games, goalsFor, goalsAgainst, points, descrLat) VALUES(?, ?, ?, ?, ?, ?, ?, ?, ?, ?)', [e.group, e.name, e.description, e.place, e.logo, e.games, e.goalsFor, e.goalsAgainst, e.points, e.descrLat], (err => {
            if(err) throw err;
        }));
    });
    ...
    uclStandingsE.map((e) => {
        db.query('INSERT INTO uclstandingse (standingsGroup, name, description, place, logo, games, goalsFor, goalsAgainst, points, descrLat) VALUES(?, ?, ?, ?, ?, ?, ?, ?, ?, ?)', [e.group, e.name, e.description, e.place, e.logo, e.games, e.goalsFor, e.goalsAgainst, e.points, e.descrLat], (err => {
            if(err) throw err;
        }));
    });
    ...
    uclStandingsF.map((e) => {
        db.query('INSERT INTO uclstandingsf (standingsGroup, name, description, place, logo, games, goalsFor, goalsAgainst, points, descrLat) VALUES(?, ?, ?, ?, ?, ?, ?, ?, ?, ?)', [e.group, e.name, e.description, e.place, e.logo, e.games, e.goalsFor, e.goalsAgainst, e.points, e.descrLat], (err => {
            if(err) throw err;
        }));
    });
    ...
    uclStandingsG.map((e) => {
        db.query('INSERT INTO uclstandingsg (standingsGroup, name, description, place, logo, games, goalsFor, goalsAgainst, points, descrLat) VALUES(?, ?, ?, ?, ?, ?, ?, ?, ?, ?)', [e.group, e.name, e.description, e.place, e.logo, e.games, e.goalsFor, e.goalsAgainst, e.points, e.descrLat], (err => {
            if(err) throw err;
        }));
    });
    ...
    uclStandingsH.map((e) => {
        db.query('INSERT INTO uclstandingsh (standingsGroup, name, description, place, logo, games, goalsFor, goalsAgainst, points, descrLat) VALUES(?, ?, ?, ?, ?, ?, ?, ?, ?, ?)', [e.group, e.name, e.description, e.place, e.logo, e.games, e.goalsFor, e.goalsAgainst, e.points, e.descrLat], (err => {
            if(err) throw err;
        }));
    });
    ...
    uelStandingsA.map((e) => {
        db.query('INSERT INTO uelstandingsa (standingsGroup, name, description, place, logo, games, goalsFor, goalsAgainst, points, descrLat) VALUES(?, ?, ?, ?, ?, ?, ?, ?, ?, ?)', [e.group, e.name, e.description, e.place, e.logo, e.games, e.goalsFor, e.goalsAgainst, e.points, e.descrLat], (err => {
            if(err) throw err;
        }));
    });
    ...
    uelStandingsB.map((e) => {
        db.query('INSERT INTO uelstandingsb (standingsGroup, name, description, place, logo, games, goalsFor, goalsAgainst, points, descrLat) VALUES(?, ?, ?, ?, ?, ?, ?, ?, ?, ?)', [e.group, e.name, e.description, e.place, e.logo, e.games, e.goalsFor, e.goalsAgainst, e.points, e.descrLat], (err => {
            if(err) throw err;
        }));
    });
    ...
    uelStandingsC.map((e) => {
        db.query('INSERT INTO uelstandingsc (standingsGroup, name, description, place, logo, games, goalsFor, goalsAgainst, points, descrLat) VALUES(?, ?, ?, ?, ?, ?, ?, ?, ?, ?)', [e.group, e.name, e.description, e.place, e.logo, e.games, e.goalsFor, e.goalsAgainst, e.points, e.descrLat], (err => {
            if(err) throw err;
        }));
    });
    ...
    uelStandingsD.map((e) => {
        db.query('INSERT INTO uelstandingsd (standingsGroup, name, description, place, logo, games, goalsFor, goalsAgainst, points, descrLat) VALUES(?, ?, ?, ?, ?, ?, ?, ?, ?, ?)', [e.group, e.name, e.description, e.place, e.logo, e.games, e.goalsFor, e.goalsAgainst, e.points, e.descrLat], (err => {
            if(err) throw err;
        }));
    });
    ...
    uelStandingsE.map((e) => {
        db.query('INSERT INTO uelstandingse (standingsGroup, name, description, place, logo, games, goalsFor, goalsAgainst, points, descrLat) VALUES(?, ?, ?, ?, ?, ?, ?, ?, ?, ?)', [e.group, e.name, e.description, e.place, e.logo, e.games, e.goalsFor, e.goalsAgainst, e.points, e.descrLat], (err => {
            if(err) throw err;
        }));
    });
    ...
    uelStandingsF.map((e) => {
        db.query('INSERT INTO uelstandingsf (standingsGroup, name, description, place, logo, games, goalsFor, goalsAgainst, points, descrLat) VALUES(?, ?, ?, ?, ?, ?, ?, ?, ?, ?)', [e.group, e.name, e.description, e.place, e.logo, e.games, e.goalsFor, e.goalsAgainst, e.points, e.descrLat], (err => {
            if(err) throw err;
        }));
    });
    ...
    uelStandingsG.map((e) => {
        db.query('INSERT INTO uelstandingsg (standingsGroup, name, description, place, logo, games, goalsFor, goalsAgainst, points, descrLat) VALUES(?, ?, ?, ?, ?, ?, ?, ?, ?, ?)', [e.group, e.name, e.description, e.place, e.logo, e.games, e.goalsFor, e.goalsAgainst, e.points, e.descrLat], (err => {
            if(err) throw err;
        }));
    });
    ...
    uelStandingsH.map((e) => {
        db.query('INSERT INTO uelstandingsh (standingsGroup, name, description, place, logo, games, goalsFor, goalsAgainst, points, descrLat) VALUES(?, ?, ?, ?, ?, ?, ?, ?, ?, ?)', [e.group, e.name, e.description, e.place, e.logo, e.games, e.goalsFor, e.goalsAgainst, e.points, e.descrLat], (err => {
            if(err) throw err;
        }));
    });
    ...
    ueclStandingsA.map((e) => {
        db.query('INSERT INTO ueclstandingsa (standingsGroup, name, description, place, logo, games, goalsFor, goalsAgainst, points, descrLat) VALUES(?, ?, ?, ?, ?, ?, ?, ?, ?, ?)', [e.group, e.name, e.description, e.place, e.logo, e.games, e.goalsFor, e.goalsAgainst, e.points, e.descrLat], (err => {
            if(err) throw err;
        }));
    });
    ...
    ueclStandingsB.map((e) => {
        db.query('INSERT INTO ueclstandingsb (standingsGroup, name, description, place, logo, games, goalsFor, goalsAgainst, points, descrLat) VALUES(?, ?, ?, ?, ?, ?, ?, ?, ?, ?)', [e.group, e.name, e.description, e.place, e.logo, e.games, e.goalsFor, e.goalsAgainst, e.points, e.descrLat], (err => {
            if(err) throw err;
        }));
    });
    ...
    ueclStandingsC.map((e) => {
        db.query('INSERT INTO ueclstandingsc (standingsGroup, name, description, place, logo, games, goalsFor, goalsAgainst, points, descrLat) VALUES(?, ?, ?, ?, ?, ?, ?, ?, ?, ?)', [e.group, e.name, e.description, e.place, e.logo, e.games, e.goalsFor, e.goalsAgainst, e.points, e.descrLat], (err => {
            if(err) throw err;
        }));
    });
    ...
    ueclStandingsD.map((e) => {
        db.query('INSERT INTO ueclstandingsd (standingsGroup, name, description, place, logo, games, goalsFor, goalsAgainst, points, descrLat) VALUES(?, ?, ?, ?, ?, ?, ?, ?, ?, ?)', [e.group, e.name, e.description, e.place, e.logo, e.games, e.goalsFor, e.goalsAgainst, e.points, e.descrLat], (err => {
            if(err) throw err;
        }));
    });
    ...
    ueclStandingsE.map((e) => {
        db.query('INSERT INTO ueclstandingse (standingsGroup, name, description, place, logo, games, goalsFor, goalsAgainst, points, descrLat) VALUES(?, ?, ?, ?, ?, ?, ?, ?, ?, ?)', [e.group, e.name, e.description, e.place, e.logo, e.games, e.goalsFor, e.goalsAgainst, e.points, e.descrLat], (err => {
            if(err) throw err;
        }));
    });
    ...
    ueclStandingsF.map((e) => {
        db.query('INSERT INTO ueclstandingsf (standingsGroup, name, description, place, logo, games, goalsFor, goalsAgainst, points, descrLat) VALUES(?, ?, ?, ?, ?, ?, ?, ?, ?, ?)', [e.group, e.name, e.description, e.place, e.logo, e.games, e.goalsFor, e.goalsAgainst, e.points, e.descrLat], (err => {
            if(err) throw err;
        }));
    });
    ...
    ueclStandingsG.map((e) => {
        db.query('INSERT INTO ueclstandingsg (standingsGroup, name, description, place, logo, games, goalsFor, goalsAgainst, points, descrLat) VALUES(?, ?, ?, ?, ?, ?, ?, ?, ?, ?)', [e.group, e.name, e.description, e.place, e.logo, e.games, e.goalsFor, e.goalsAgainst, e.points, e.descrLat], (err => {
            if(err) throw err;
        }));
    });
    ...
    ueclStandingsH.map((e) => {
        db.query('INSERT INTO ueclstandingsh (standingsGroup, name, description, place, logo, games, goalsFor, goalsAgainst, points, descrLat) VALUES(?, ?, ?, ?, ?, ?, ?, ?, ?, ?)', [e.group, e.name, e.description, e.place, e.logo, e.games, e.goalsFor, e.goalsAgainst, e.points, e.descrLat], (err => {
            if(err) throw err;
        }));
    });
    ...
    unlStandingsA1.map((e) => {
        db.query('INSERT INTO unlstandingsa1 (name, description, place, logo, games, goalsFor, goalsAgainst, points, standingsGroup, descrLat) VALUES(?, ?, ?, ?, ?, ?, ?, ?, ?, ?)', [e.name, e.description, e.place, e.logo, e.games, e.goalsFor, e.goalsAgainst, e.points, e.group, e.descrLat], (err => {
            if(err) throw err;
        }));
    });
    ...
    unlStandingsA2.map((e) => {
        db.query('INSERT INTO unlstandingsa2 (name, description, place, logo, games, goalsFor, goalsAgainst, points, standingsGroup, descrLat) VALUES(?, ?, ?, ?, ?, ?, ?, ?, ?, ?)', [e.name, e.description, e.place, e.logo, e.games, e.goalsFor, e.goalsAgainst, e.points, e.group, e.descrLat], (err => {
            if(err) throw err;
        }));
    });
    ...
    unlStandingsA3.map((e) => {
        db.query('INSERT INTO unlstandingsa3 (name, description, place, logo, games, goalsFor, goalsAgainst, points, standingsGroup, descrLat) VALUES(?, ?, ?, ?, ?, ?, ?, ?, ?, ?)', [e.name, e.description, e.place, e.logo, e.games, e.goalsFor, e.goalsAgainst, e.points, e.group, e.descrLat], (err => {
            if(err) throw err;
        }));
    });
    ...
    unlStandingsA4.map((e) => {
        db.query('INSERT INTO unlstandingsa4 (name, description, place, logo, games, goalsFor, goalsAgainst, points, standingsGroup, descrLat) VALUES(?, ?, ?, ?, ?, ?, ?, ?, ?, ?)', [e.name, e.description, e.place, e.logo, e.games, e.goalsFor, e.goalsAgainst, e.points, e.group, e.descrLat], (err => {
            if(err) throw err;
        }));
    });
    ...
    unlStandingsB1.map((e) => {
        db.query('INSERT INTO unlstandingsb1 (name, description, place, logo, games, goalsFor, goalsAgainst, points, standingsGroup, descrLat) VALUES(?, ?, ?, ?, ?, ?, ?, ?, ?, ?)', [e.name, e.description, e.place, e.logo, e.games, e.goalsFor, e.goalsAgainst, e.points, e.group, e.descrLat], (err => {
            if(err) throw err;
        }));
    });
    ...
    unlStandingsB2.map((e) => {
        db.query('INSERT INTO unlstandingsb2 (name, description, place, logo, games, goalsFor, goalsAgainst, points, standingsGroup, descrLat) VALUES(?, ?, ?, ?, ?, ?, ?, ?, ?, ?)', [e.name, e.description, e.place, e.logo, e.games, e.goalsFor, e.goalsAgainst, e.points, e.group, e.descrLat], (err => {
            if(err) throw err;
        }));
    });
    ...
    unlStandingsB3.map((e) => {
        db.query('INSERT INTO unlstandingsb3 (name, description, place, logo, games, goalsFor, goalsAgainst, points, standingsGroup, descrLat) VALUES(?, ?, ?, ?, ?, ?, ?, ?, ?, ?)', [e.name, e.description, e.place, e.logo, e.games, e.goalsFor, e.goalsAgainst, e.points, e.group, e.descrLat], (err => {
            if(err) throw err;
        }));
    });
    ...
    unlStandingsB4.map((e) => {
        db.query('INSERT INTO unlstandingsb4 (name, description, place, logo, games, goalsFor, goalsAgainst, points, standingsGroup, descrLat) VALUES(?, ?, ?, ?, ?, ?, ?, ?, ?, ?)', [e.name, e.description, e.place, e.logo, e.games, e.goalsFor, e.goalsAgainst, e.points, e.group, e.descrLat], (err => {
            if(err) throw err;
        }));
    });
    ...
    unlStandingsC1.map((e) => {
        db.query('INSERT INTO unlstandingsc1 (name, description, place, logo, games, goalsFor, goalsAgainst, points, standingsGroup, descrLat) VALUES(?, ?, ?, ?, ?, ?, ?, ?, ?, ?)', [e.name, e.description, e.place, e.logo, e.games, e.goalsFor, e.goalsAgainst, e.points, e.group, e.descrLat], (err => {
            if(err) throw err;
        }));
    });
    ...
    unlStandingsC2.map((e) => {
        db.query('INSERT INTO unlstandingsc2 (name, description, place, logo, games, goalsFor, goalsAgainst, points, standingsGroup, descrLat) VALUES(?, ?, ?, ?, ?, ?, ?, ?, ?, ?)', [e.name, e.description, e.place, e.logo, e.games, e.goalsFor, e.goalsAgainst, e.points, e.group, e.descrLat], (err => {
            if(err) throw err;
        }));
    });
    ...
    unlStandingsC3.map((e) => {
        db.query('INSERT INTO unlstandingsc3 (name, description, place, logo, games, goalsFor, goalsAgainst, points, standingsGroup, descrLat) VALUES(?, ?, ?, ?, ?, ?, ?, ?, ?, ?)', [e.name, e.description, e.place, e.logo, e.games, e.goalsFor, e.goalsAgainst, e.points, e.group, e.descrLat], (err => {
            if(err) throw err;
        }));
    });
    ...
    unlStandingsC4.map((e) => {
        db.query('INSERT INTO unlstandingsc4 (name, description, place, logo, games, goalsFor, goalsAgainst, points, standingsGroup, descrLat) VALUES(?, ?, ?, ?, ?, ?, ?, ?, ?, ?)', [e.name, e.description, e.place, e.logo, e.games, e.goalsFor, e.goalsAgainst, e.points, e.group, e.descrLat], (err => {
            if(err) throw err;
        }));
    });
    ...
    unlStandingsD1.map((e) => {
        db.query('INSERT INTO unlstandingsd1 (name, description, place, logo, games, goalsFor, goalsAgainst, points, standingsGroup, descrLat) VALUES(?, ?, ?, ?, ?, ?, ?, ?, ?, ?)', [e.name, e.description, e.place, e.logo, e.games, e.goalsFor, e.goalsAgainst, e.points, e.group, e.descrLat], (err => {
            if(err) throw err;
        }));
    });
    ...
    unlStandingsD2.map((e) => {
        db.query('INSERT INTO unlstandingsd2 (name, description, place, logo, games, goalsFor, goalsAgainst, points, standingsGroup, descrLat) VALUES(?, ?, ?, ?, ?, ?, ?, ?, ?, ?)', [e.name, e.description, e.place, e.logo, e.games, e.goalsFor, e.goalsAgainst, e.points, e.group, e.descrLat], (err => {
            if(err) throw err;
        }));
    });
    ...
    euroQualStandingsA.map((e) => {
        db.query('INSERT INTO euroqualstandingsa (name, descrClass, place, logo, games, goalsFor, goalsAgainst, points, standingsGroup) VALUES(?, ?, ?, ?, ?, ?, ?, ?, ?)', [e.name, e.descrClass, e.place, e.logo, e.games, e.goalsFor, e.goalsAgainst, e.points, e.group], (err => {
            if(err) throw err;
        }));
    });
    ...
    euroQualStandingsB.map((e) => {
        db.query('INSERT INTO euroqualstandingsb (name, descrClass, place, logo, games, goalsFor, goalsAgainst, points, standingsGroup) VALUES(?, ?, ?, ?, ?, ?, ?, ?, ?)', [e.name, e.descrClass, e.place, e.logo, e.games, e.goalsFor, e.goalsAgainst, e.points, e.group], (err => {
            if(err) throw err;
        }));
    });
    ...
    euroQualStandingsC.map((e) => {
        db.query('INSERT INTO euroqualstandingsc (name, descrClass, place, logo, games, goalsFor, goalsAgainst, points, standingsGroup) VALUES(?, ?, ?, ?, ?, ?, ?, ?, ?)', [e.name, e.descrClass, e.place, e.logo, e.games, e.goalsFor, e.goalsAgainst, e.points, e.group], (err => {
            if(err) throw err;
        }));
    });
    ...
    euroQualStandingsD.map((e) => {
        db.query('INSERT INTO euroqualstandingsd (name, descrClass, place, logo, games, goalsFor, goalsAgainst, points, standingsGroup) VALUES(?, ?, ?, ?, ?, ?, ?, ?, ?)', [e.name, e.descrClass, e.place, e.logo, e.games, e.goalsFor, e.goalsAgainst, e.points, e.group], (err => {
            if(err) throw err;
        }));
    });
    ...
    euroQualStandingsE.map((e) => {
        db.query('INSERT INTO euroqualstandingse (name, descrClass, place, logo, games, goalsFor, goalsAgainst, points, standingsGroup) VALUES(?, ?, ?, ?, ?, ?, ?, ?, ?)', [e.name, e.descrClass, e.place, e.logo, e.games, e.goalsFor, e.goalsAgainst, e.points, e.group], (err => {
            if(err) throw err;
        }));
    });
    ...
    euroQualStandingsF.map((e) => {
        db.query('INSERT INTO euroqualstandingsf (name, descrClass, place, logo, games, goalsFor, goalsAgainst, points, standingsGroup) VALUES(?, ?, ?, ?, ?, ?, ?, ?, ?)', [e.name, e.descrClass, e.place, e.logo, e.games, e.goalsFor, e.goalsAgainst, e.points, e.group], (err => {
            if(err) throw err;
        }));
    });
    ...
    euroQualStandingsG.map((e) => {
        db.query('INSERT INTO euroqualstandingsg (name, descrClass, place, logo, games, goalsFor, goalsAgainst, points, standingsGroup) VALUES(?, ?, ?, ?, ?, ?, ?, ?, ?)', [e.name, e.descrClass, e.place, e.logo, e.games, e.goalsFor, e.goalsAgainst, e.points, e.group], (err => {
            if(err) throw err;
        }));
    });
    ...
    euroQualStandingsH.map((e) => {
        db.query('INSERT INTO euroqualstandingsh (name, descrClass, place, logo, games, goalsFor, goalsAgainst, points, standingsGroup) VALUES(?, ?, ?, ?, ?, ?, ?, ?, ?)', [e.name, e.descrClass, e.place, e.logo, e.games, e.goalsFor, e.goalsAgainst, e.points, e.group], (err => {
            if(err) throw err;
        }));
    });
    ...
    euroQualStandingsI.map((e) => {
        db.query('INSERT INTO euroqualstandingsi (name, descrClass, place, logo, games, goalsFor, goalsAgainst, points, standingsGroup) VALUES(?, ?, ?, ?, ?, ?, ?, ?, ?)', [e.name, e.descrClass, e.place, e.logo, e.games, e.goalsFor, e.goalsAgainst, e.points, e.group], (err => {
            if(err) throw err;
        }));
    });
    ...
    euroQualStandingsJ.map((e) => {
        db.query('INSERT INTO euroqualstandingsj (name, descrClass, place, logo, games, goalsFor, goalsAgainst, points, standingsGroup) VALUES(?, ?, ?, ?, ?, ?, ?, ?, ?)', [e.name, e.descrClass, e.place, e.logo, e.games, e.goalsFor, e.goalsAgainst, e.points, e.group], (err => {
            if(err) throw err;
        }));
    });
    ...
    .then(response => {
        ...
        rplInfo.push({
            seasonInfo: $('#branding-layout > div > div.contentLayout.js-active > div.c-tag-header.tag-main-block > div > div.short-info > div.descr').text()
        });
    })
    .catch(err => console.log(err));
